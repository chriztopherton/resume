...
def home_page(skills_data):
    ...
    with col2:
        ...
        st.markdown(
            '<p class="contact-info">Machine Learning & Data Engineer | vchristopherton@gmail.com | San Diego County, CA</p>',
            unsafe_allow_html=True,
        )
    ...
    with col1:
        ...
        **What I Bring to the Table:**
        ...
        - **Cloud Platforms**: Extensive expertise with AWS, Azure, and GCP ecosystems
